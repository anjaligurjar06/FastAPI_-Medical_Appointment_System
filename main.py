...
@app.get("/")
def home():
    return {"message": "Welcome to CarePoint Clinic"}


# Doctors Data
doctors = [
    {"id": 1, "name": "Dr. Anish", "specialization": "Cardiologist", "fee": 500, "experience_years": 10, "is_available": True},
    {"id": 2, "name": "Dr. Sarthak", "specialization": "Dermatologist", "fee": 300, "experience_years": 5, "is_available": True},
    {"id": 3, "name": "Dr. Akshay", "specialization": "Pediatrician", "fee": 400, "experience_years": 8, "is_available": False},
    {"id": 4, "name": "Dr. Diksha", "specialization": "General", "fee": 200, "experience_years": 3, "is_available": True},
    {"id": 5, "name": "Dr. Sahil", "specialization": "Cardiologist", "fee": 600, "experience_years": 15, "is_available": True},
    {"id": 6, "name": "Dr. Anjali", "specialization": "Dermatologist", "fee": 350, "experience_years": 7, "is_available": False},
]
